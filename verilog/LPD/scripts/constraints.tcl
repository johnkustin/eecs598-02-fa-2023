...
set_input_delay -max [expr $clock_period * 0.2] [get_ports -filter "direction == in" write_lut_idx*] -clock core_clk
set_input_delay -min [expr $clock_period * 0.1] [get_ports -filter "direction == in" write_lut_idx*] -clock core_clk
