...
set_input_delay -max [expr $clock_period * 0.3] [get_ports -filter "direction == in" data_in*] -clock core_clk
set_input_delay -min [expr $clock_period * 0.1] [get_ports -filter "direction == in" data_in*] -clock core_clk
set_input_delay -max [expr $clock_period * 0.3] [get_ports -filter "direction == in" valid_in*] -clock core_clk
