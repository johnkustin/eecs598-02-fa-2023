...
set RTL_SOURCE_FILES  [glob -nocomplain -directory src/ *.svh *.vh *.v *.sv ]
lappend RTL_SOURCE_FILES [glob -nocomplain -directory ../W/src *.svh *.vh *.v *.sv]
lappend RTL_SOURCE_FILES [glob -nocomplain -directory ../Shat/src *.svh *.vh *.v *.sv]
lappend RTL_SOURCE_FILES [glob -nocomplain -directory ../QNS/src/ *.svh *.vh *.v *.sv ]
lappend RTL_SOURCE_FILES [glob -nocomplain -directory ../LMS/src/ *.svh *.vh *.v *.sv]
lappend RTL_SOURCE_FILES [glob -nocomplain -directory ../LMS/memory/results/SRAM128x12_single/ *.svh *.vh *.v *.sv]
lappend RTL_SOURCE_FILES [glob -nocomplain -directory ../W_top/src/ *.svh *.vh *.v *.sv]
lappend RTL_SOURCE_FILES [glob -nocomplain -directory ../LPD/src/ *.svh *.vh *.v *.sv]
set NETLIST_FILES ""
set DESIGN_DEFINES ""
set DESIGN_PATH          "[pwd]"
