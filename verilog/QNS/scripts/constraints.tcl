...
set_input_delay -max [expr $clock_period * 0.2] [get_ports -filter "direction == in" valid_in*] -clock core_clk
set_input_delay -min [expr $clock_period * 0.1] [get_ports -filter "direction == in" valid_in*] -clock core_clk
set_input_delay -max [expr $clock_period * 0.2] [get_ports -filter "direction == in" x_in*] -clock core_clk
set_input_delay -min [expr $clock_period * 0.1] [get_ports -filter "direction == in" x_in*] -clock core_clk
set_output_delay -max [expr $clock_period * 0.5] [get_ports -filter "direction == out" y_out*] -clock core_clk
set_output_delay -min [expr $clock_period * 0.4] [get_ports -filter "direction == out" y_out*] -clock core_clk
